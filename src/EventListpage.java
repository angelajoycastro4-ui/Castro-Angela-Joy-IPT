 ...
 * @author angel
 */
public class EventListpage extends javax.swing.JFrame {

    /**
     * Creates new form EventListpage
     */
    ...
    private void initComponents() {
        ...
        meetingtextfield = new javax.swing.JTextField();
        ...
        eventnamefield.setBackground(new java.awt.Color(255, 255, 204));

        notestextpane.setBackground(new java.awt.Color(255, 255, 204));
        ...
        jLabel4.setText("MEETING/LOCATION:");

        meetingtextfield.setBackground(new java.awt.Color(255, 255, 204));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(204, 102, 0));
        jLabel5.setText("DATE:");

        ViewSummarybutton.setBackground(new java.awt.Color(255, 153, 51));
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(meetingtextfield))
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                .addComponent(jLabel1)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(eventnamefield, javax.swing.GroupLayout.PREFERRED_SIZE, 222, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                .addComponent(jLabel3)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(birthdaytextfield, javax.swing.GroupLayout.PREFERRED_SIZE, 241, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(ViewSummarybutton)
                                .addGap(56, 56, 56)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(meetingtextfield, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel4))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
          ...
          String meeting = meetingtextfield.getText();
          String notes = notestextpane.getText();
          String date = datefield.getText();
          
        if(eventname.equals("") || birthday.equals("") || meeting.equals("") || notes.equals("") || date.equals("")) {
    ...
    private void ViewSummarybuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ViewSummarybuttonActionPerformed
       ...
       String eventname = eventnamefield.getText();
        ...
        JOptionPane.showMessageDialog(null, detailedSummary, "Saved Details Confirmation", JOptionPane.PLAIN_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EventListpage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EventListpage().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField meetingtextfield;
